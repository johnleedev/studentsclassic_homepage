...
export default function Arias(props:any) {
    ...
    <div className="subpage__main">
      ...
      <div className="subpage__main__search">
        ...
        <div className="subpage__main__search__box">
          ...
          <input className="inputdefault width" type="text"
            value={word} onChange={(e)=>{setWord(e.target.value)}} placeholder='곡명, 오페라명, 작곡가명 검색'
            />
                  ...
                  list.map((item:any, index:any)=>{
                    return(
                      <ul className="textRow" key={index}
                        onClick={()=>{
                          isLogin 
                          ? navigate('/study/ariasdetail', {state : {data:item, sort:props.sort}})
